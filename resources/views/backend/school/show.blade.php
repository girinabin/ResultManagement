                ...
                <div class="col-md-3">
                 <div class="card">
                     <div class="card-header">
                         <p class="card-text ">
                             {{ ucfirst($class->name) }}
                                ...
                                <button type="button" class="btn  btn-sm" data-toggle="modal" data-target=".bd-edit-modal-sm{{ $class->id }}"><i class="fas fa-edit"></i></button>
                           
                                <button type="button" class="btn  btn-sm float-right" data-toggle="modal" data-target=".bd-delete-modal-sm{{ $class->id }}"><i class="fas fa-trash"></i></button>
                     ...
                     <div class="card-body text-center">
                       ...
                       <a href="#" class="btn btn-primary btn-sm ">Add Students</a>
                     </div>
                   </div>
                    </div> 
             @empty
...
<div class="modal fade bd-edit-modal-sm{{ $class->id }}" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
...
{{-- Delete Class modal --}}
@forelse ($classes as $class)
<div class="modal fade bd-delete-modal-sm{{ $class->id }}" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
